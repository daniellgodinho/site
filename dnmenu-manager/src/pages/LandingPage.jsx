...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-black to-purple-950/50 text-white overflow-x-hidden">
...
function Header({ mobileMenuOpen, setMobileMenuOpen }) {
    ...
    return (
        <motion.header
            ...
            className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-gradient-to-br from-gray-950 to-purple-950/30 backdrop-blur-md border-b border-purple-800/20 shadow-lg' : 'bg-transparent'
                }`}
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    <Link to="/" className="flex items-center space-x-3">
                        <Logo className="w-20 h-20 md:w-20 h-20 lg:w-40 h-40 drop-shadow-xl" />
                    ...
                    <nav className="hidden md:flex items-center space-x-8">
                        ...
                        <Link
                            to="/login"
                            className="px-6 py-2.5 bg-purple-600 hover:bg-purple-500 text-white rounded-xl transition-all duration-300 shadow-md shadow-purple-900/20"
                        >
                            Dashboard
                        </Link>
                    </nav>
                ...
                {mobileMenuOpen && (
                    <motion.div
                        ...
                        className="md:hidden py-4 space-y-4 bg-gray-950/50 rounded-b-2xl"
                    >
                        <a href="#features" className="block text-gray-300 hover:text-white transition-colors py-2 px-4">
                            Funções
                        </a>
                        <a href="#pricing" className="block text-gray-300 hover:text-white transition-colors py-2 px-4">
                            Preços
                        </a>
                        <a href="https://discord.gg/k3CUqNs3UW" target="_blank" rel="noopener noreferrer" className="block text-gray-300 hover:text-white transition-colors py-2 px-4">
                            Discord
                        </a>
                        <a href="#revendedores" className="block text-gray-300 hover:text-white transition-colors py-2 px-4">
                            Revendedores
                        </a>
                        <a href="#termos" className="block text-gray-300 hover:text-white transition-colors py-2 px-4">
                            Termos
                        </a>
                        <Link
                            to="/login"
                            className="block px-6 py-2.5 bg-purple-600 hover:bg-purple-500 text-white rounded-xl transition-all duration-300 text-center mx-4"
                        >
                            Dashboard
                        </Link>
                    </motion.div>
                ...
                >
                    ...
                    >
                        <a
                            ...
                            className="group relative px-8 py-4 bg-purple-600 rounded-2xl font-semibold text-lg overflow-hidden transition-all duration-300 hover:scale-105 shadow-md shadow-purple-900/20 text-white"
                        >
                            Adquirir Acesso
                        </a>
                        <a
                            href="#features"
                            className="px-8 py-4 bg-gray-900/50 border border-purple-800/30 rounded-2xl font-semibold text-lg hover:bg-gray-800/50 transition-all duration-300 text-white"
                        >
                            Ver Funções
                        </a>
                    </motion.div>
        ...
        <section ref={ref} className="py-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="relative">
                    ...
                    <div className="relative bg-gradient-to-br from-gray-950 to-purple-950/30 rounded-2xl p-8 border border-purple-800/30 shadow-2xl">
                        <div className="flex items-center gap-2 mb-6">
                            <div className="w-3 h-3 rounded-full bg-red-500"></div>
                            <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
                            <div className="w-3 h-3 rounded-full bg-green-500"></div>
                            <span className="ml-4 text-gray-300 text-sm">DN Menu v4.5.3</span>
                        </div>
                        <div className="bg-black/50 rounded-xl p-6 font-mono text-sm">
                            ...
                            <div className="text-gray-300 mb-2">Carregando módulos de combate...</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {keyFeatures.map((feature, index) => (
                        <motion.div
                            ...
                            whileHover={{ y: -5 }}
                            className="group relative p-6 bg-gradient-to-br from-gray-950 to-purple-950/30 rounded-2xl border border-purple-800/20 hover:border-purple-600/50 transition-all duration-300 shadow-xl shadow-purple-900/10"
                        >
                    ...
                    {Object.entries(allFeatures).map(([category, data], catIndex) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="bg-gradient-to-br from-gray-950 to-purple-950/30 rounded-2xl p-6 border border-purple-800/20 shadow-xl"
                            >
                                <div className="flex items-center gap-3 mb-4">
                                    <div className="w-10 h-10 bg-purple-600/20 border border-purple-800/40 rounded-lg flex items-center justify-center">
                    ...
                    {plans.map((plan, index) => (
                        <motion.div
                            ...
                            className={`relative p-12 rounded-3xl border-2 transition-all duration-700 shadow-2xl ${plan.highlighted
                                ? 'bg-gradient-to-br from-purple-900/40 to-purple-900/20 border-purple-600 shadow-purple-600/50'
                                : 'bg-gradient-to-br from-gray-950/95 to-black/95 border-purple-800/40 hover:border-purple-600'
                                }`}
                        >
                            {plan.badge && (
                                <motion.div
                            ...
                            <motion.a
                                ...
                                className={`block w-full py-6 rounded-2xl text-center font-extrabold text-xl transition-all duration-300 shadow-xl ${plan.highlighted
                                    ...
                                    : 'bg-gray-900/50 hover:bg-gray-800/50 text-white border-2 border-purple-800/40'
                                    }`}
                            >
                                Adquirir Agora
                            </motion.a>
        ...
        <section ref={ref} className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-purple-900/5 to-transparent">
            <div className="max-w-4xl mx-auto">
                <motion.div
                    ...
                    animate={isInView ? { opacity: 1, y: 0 } : {}}
                    transition={{ duration: 0.8 }}
                    className="bg-gradient-to-br from-gray-950 to-purple-950/30 rounded-2xl p-8 border border-purple-800/30 shadow-2xl"
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {resellers.map((res, index) => (
                        <motion.div
                            ...
                            animate={isInView ? { opacity: 1, y: 0 } : {}}
                            transition={{ duration: 0.5, delay: index * 0.1 }}
                            className="bg-gradient-to-br from-gray-950 to-purple-950/30 rounded-2xl p-6 border border-purple-800/20 hover:border-purple-600/50 transition-all duration-300 shadow-xl"
                        >
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center justify-center gap-2 px-4 py-2 bg-purple-600 rounded-lg font-semibold hover:bg-purple-500 transition-colors text-white"
                            >
                ...
                <div className="space-y-4">
                    {termsSections.map((section, index) => (
                        <motion.details
                            ...
                            animate={isInView ? { opacity: 1, y: 0 } : {}}
                            transition={{ duration: 0.5, delay: index * 0.1 }}
                            className="group bg-gradient-to-br from-gray-950 to-purple-950/30 rounded-2xl p-6 border border-purple-800/20 cursor-pointer hover:border-purple-600/50 transition-all shadow-xl"
                        >
    ...
    return (
        <footer className="py-12 px-4 sm:px-6 lg:px-8 border-t border-purple-800/20">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    <div>
                        <div className="flex items-center space-x-3 mb-4">
                            <Logo className="w-24 h-24 md:w-24 h-24 lg:w-40 h-40 drop-shadow-xl" />
                ...
                <div className="pt-8 border-t border-purple-800/20 text-center text-gray-300 text-sm">
