...
export default async function handler(req, res) {
    // Verifica se é seu IP ou requisição do Roblox
    ...
    const loaderCode = `-- DN Softwares - Loader Menu (Apenas DN Menu)
...
-- Carrega apenas o DN Menu
load("dnmenu")

print("DN Menu carregado com sucesso!")
`;
